    ...
    >
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center px-5 py-20 sm:px-6 sm:py-24">
        ...
        <div className="relative mb-10 flex items-center justify-center">
          {/* Badge: experience — top left of photo */}
          <motion.div
            {...popIn(0.6)}
          ...
          {/* Badge: available — bottom right of photo */}
          <motion.div
            {...popIn(0.75)}
        ...
        <motion.span
          {...fadeUp(0.15)}
          className="mb-5 inline-block text-[11px] uppercase tracking-widest text-foreground/50"
        >
        ...
        <motion.h1
          {...fadeUp(0.3)}
          className="font-serif mb-6 text-center text-foreground"
          style={{
        ...
        <motion.p
          {...fadeUp(0.45)}
          className="mb-10 max-w-lg text-center text-base leading-relaxed text-foreground/60"
        >
          Product Designer com foco em discovery, métricas e estratégia —
          transformando complexidade em produtos digitais que funcionam de
          verdade.
        </motion.p>
